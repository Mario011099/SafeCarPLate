...
class MainActivityOCR : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    //my
    placaImageView = findViewById(R.id.placa_imageview)
    //my
    val candidateImageViews = arrayOf<ImageView>(tfImageView, androidImageView, chromeImageView, placaImageView)
      ...
      object : View.OnTouchListener {
        override fun onTouch(v: View, event: MotionEvent?): Boolean {
          if (v.equals(tfImageView)) {
            ...
            //my
          } else if (v.equals(placaImageView)) { //my
            selectedImageName = placaImageName
  ...
  private fun setChipsToLogView(itemsFound: Map<String, Int>) {
    ...
    if(wordsList.isNotEmpty()) {
      var intent = Intent(this, org.tensorflow.lite.examples.ocr.Result::class.java)
      val bundle = Bundle()
